...
namespace ACCDataAdapter.DPApp
{
    public class OutgoingInvoiceDAL : BaseDAL
    {
        ...
        {
            return await ReadDPAppObjectAsync<OutgoingInvoice>(Properties.Resources.ReadOutgoingInvoices, ReadOutgoingInvoiceFromDataReader, cancellationToken);
        }

        private OutgoingInvoice ReadOutgoingInvoiceFromDataReader(DbDataReader reader)
        {
            return new()
            {
        ...
        {
            return await ReadDPAppObjectAsync<OutgoingInvoicePosition>(Properties.Resources.ReadOutgoingInvoicePositions, ReadOutgoingInvoicePositionFromDataReader, cancellationToken);
        }

        private OutgoingInvoicePosition ReadOutgoingInvoicePositionFromDataReader(DbDataReader reader)
        {
            return new()
            {
                Id = reader.GetInt64("id"),
