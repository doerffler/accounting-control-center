...
namespace DoePaAdminApp
{
    ...
    public partial class App : Application
    {
        ...
        private static void ConfigureServices(IConfiguration configuration, IServiceCollection services)
        {
            ...
            services.AddTransient<ManageKostenstellenViewModel>();
            services.AddTransient<ManageMitarbeiterViewModel>();
            services.AddTransient<ManageProjekteViewModel>();
            services.AddTransient<ManageAuftraegeViewModel>();
            services.AddTransient<ImportOutgoingInvoicesViewModel>();
            services.AddTransient<ImportKostenstellenViewModel>();
            services.AddTransient<ManageAusgangsrechnungenViewModel>();
            services.AddTransient<ManageDebitorenViewModel>();
            services.AddTransient<ManagePostleitzahlenViewModel>();
            services.AddTransient<ManageKundenViewModel>();
            services.AddTransient<ManageGeschaeftsjahreViewModel>();
